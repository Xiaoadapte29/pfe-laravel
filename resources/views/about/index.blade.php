        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center space-y-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('services.index') }}" class="inline-flex items-center justify-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-md text-lg transition-colors">
                        Get Started
                    ...
                    <a href="{{ route('contact') }}" class="inline-flex items-center justify-center px-6 py-3 border border-gray-300 hover:bg-gray-50 font-medium rounded-md text-lg transition-colors">
                        Contact Us
                    </a>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-5 gap-16 items-center">
                <div class="lg:col-span-2">
                    <div class="sticky top-8">
                        ...
                        <a href="{{ route('professionals.index') }}" class="inline-flex items-center justify-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-md text-lg transition-colors">
                        ...
                        <div class="flex gap-6">
                            <div class="flex-shrink-0">
                                <div class="w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center">
                                    <span class="text-white font-bold text-sm">{{ $milestone['year'] }}</span>
                                </div>
                            </div>
                            <div>
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16">
                @foreach([
                    ...
                    <div class="text-center">
                        ...
                        <div class="text-xl font-semibold text-gray-900 mb-1">{{ $stat['label'] }}</div>
                        <div class="text-gray-600">{{ $stat['sublabel'] }}</div>
                    </div>
                @endforeach
            </div>
