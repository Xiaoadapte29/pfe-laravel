    ...
    <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto">
            <div class="bg-white rounded-lg shadow p-6">
                <h1 class="text-2xl font-bold mb-6">New Booking for {{ $service->name }}</h1>
                ...
                <form method="POST" action="{{ route('bookings.store') }}" class="space-y-4">
                    ...
                    <div class="flex gap-3 pt-4">
                        <a href="{{ route('bookings.index', ['service_id' => $service->id]) }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-gray-700 hover:bg-gray-50">
                            Cancel
                        </a>
