            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form method="POST" action="{{ route('bookings.update', $booking->id) }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                name="date"
                                type="date"
                                value="{{ old('date', \Carbon\Carbon::parse($booking->scheduled_at)->format('Y-m-d')) }}"
                                required
                                min="{{ date('Y-m-d') }}"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="time"
                                type="time"
                                value="{{ old('time', \Carbon\Carbon::parse($booking->scheduled_at)->format('H:i')) }}"
                                required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                            >
                        </div>
                    ...
                    <div class="flex gap-3 pt-4">
                        <a href="{{ route('bookings.index', ['service_id' => $booking->service_id]) }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-gray-700 hover:bg-gray-50">
                            Cancel
                        </a>
