  ...
  <div class="container mx-auto px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div class="flex flex-col items-center text-center p-6 relative">
        ...
        <div class="bg-fixhome-primary text-white w-6 h-6 rounded-full flex items-center justify-center absolute top-0 right-0 md:relative md:self-end md:top-[-16px] md:right-[-16px]">
          1
        </div>
