    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap gap-4 mb-8 overflow-x-auto pb-2">
            <?php $__currentLoopData = $specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $specialty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('professionals.index', ['specialty' => $key] + request()->except('specialty'))); ?>"
                   class="<?php echo e(request('specialty', 'all') === $key ? 'bg-blue-600 text-white' : 'bg-white text-gray-700'); ?> px-4 py-2 rounded-full shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center mb-2">
                                <input type="radio" name="location" 
                                       id="location-<?php echo e($location); ?>" 
                                       value="<?php echo e($location); ?>"
                                       <?php echo e(request('location') == $location ? 'checked' : ''); ?>

                                       class="form-radio h-4 w-4 text-blue-600">
                                <label for="location-<?php echo e($location); ?>" class="ml-2"><?php echo e($location); ?></label>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                        ...
                        <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center mb-2">
                                <input type="checkbox" name="availability[]" 
                                       id="day-<?php echo e($day); ?>" 
                                       value="<?php echo e($day); ?>"
                                       <?php echo e(in_array($day, (array)request('availability', [])) ? 'checked' : ''); ?>

                                       class="form-checkbox h-4 w-4 text-blue-600">
                                <label for="day-<?php echo e($day); ?>" class="ml-2"><?php echo e($day); ?></label>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                            ...
                            <div class="flex flex-col md:flex-row md:items-center">
                                ...
                                <div class="flex-grow">
                                    <div class="flex justify-between items-start">
                                        <div>
                                            <h3 class="text-xl font-bold"><?php echo e($professional['name']); ?></h3>
                                            <p class="text-blue-600 font-medium"><?php echo e($professional['specialty']); ?></p>
                                        </div>
                                    ...
                                    <div class="mt-2">
                                        <div class="flex items-center text-gray-600 mb-1">
                                            ...
                                            <span><?php echo e($professional['city']); ?></span>
                                        </div>
                                        <div class="flex items-center text-gray-600 mb-1">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
