        ...
        <div class="container mx-auto px-4 py-6">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Welcome back, <?php echo e($professionalData['name']); ?>!</h1>
                        <div class="flex items-center space-x-4 mt-1">
                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">
                                <?php echo e($professionalData['status'] === 'verified' ? 'Verified Professional' : 'Pending Verification'); ?>

                            </span>
                            <span class="text-sm text-gray-600 flex items-center">
                                ⭐ <?php echo e($professionalData['rating']); ?> rating
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-4 border-t">
                    <div class="flex justify-between items-center">
                        <div class="text-sm text-gray-500">
                            Showing <span class="font-medium">1</span> to <span class="font-medium"><?php echo e(count($bookings)); ?></span> of <span class="font-medium"><?php echo e(count($bookings)); ?></span> results
                        </div>
                        <div class="flex space-x-2">
