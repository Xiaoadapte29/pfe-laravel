<section class="py-16 bg-gray-50">
  <div class="container mx-auto px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      <a href="<?php echo e(url('/services')); ?>?category=plomberie" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all hover:-translate-y-1 group">
      ...
      <a href="<?php echo e(url('/services')); ?>?category=électricité" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all hover:-translate-y-1 group">
        <div class="flex flex-col items-center text-center">
          <div class="p-4 rounded-full bg-blue-50 text-fixhome-primary mb-4 group-hover:bg-fixhome-primary group-hover:text-white transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="<?php echo e(url('/services')); ?>?category=peinture" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all hover:-translate-y-1 group">
        <div class="flex flex-col items-center text-center">
          <div class="p-4 rounded-full bg-blue-50 text-fixhome-primary mb-4 group-hover:bg-fixhome-primary group-hover:text-white transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="<?php echo e(url('/services')); ?>?category=déménagement" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all hover:-translate-y-1 group">
        <div class="flex flex-col items-center text-center">
          <div class="p-4 rounded-full bg-blue-50 text-fixhome-primary mb-4 group-hover:bg-fixhome-primary group-hover:text-white transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="<?php echo e(url('/services')); ?>?category=menuiserie" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all hover:-translate-y-1 group">
        <div class="flex flex-col items-center text-center">
          <div class="p-4 rounded-full bg-blue-50 text-fixhome-primary mb-4 group-hover:bg-fixhome-primary group-hover:text-white transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="<?php echo e(url('/services')); ?>?category=jardinage" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all hover:-translate-y-1 group">
        <div class="flex flex-col items-center text-center">
          <div class="p-4 rounded-full bg-blue-50 text-fixhome-primary mb-4 group-hover:bg-fixhome-primary group-hover:text-white transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"/>
      ...
      <a href="<?php echo e(url('/services')); ?>?category=nettoyage" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all hover:-translate-y-1 group">
        <div class="flex flex-col items-center text-center">
          <div class="p-4 rounded-full bg-blue-50 text-fixhome-primary mb-4 group-hover:bg-fixhome-primary group-hover:text-white transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="<?php echo e(url('/services')); ?>?category=sécurité" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all hover:-translate-y-1 group">
        <div class="flex flex-col items-center text-center">
          <div class="p-4 rounded-full bg-blue-50 text-fixhome-primary mb-4 group-hover:bg-fixhome-primary group-hover:text-white transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\laragon\www\fixhome-laravel\resources\views/components/service-categories.blade.php ENDPATH**/ ?>